...
import { tintColorBackGround, tintColorBlack, tintColorGreenDark } from '../../constants/colors';
      ...
      <SafeAreaView style={styles.container}>
        <ScrollView contentContainerStyle={styles.scrollContent}>
          ...
          <Text style={styles.subtitle}>
            O IFNMG – Campus Pirapora conta com diversos laboratórios de informática e montagem e manutenção de hardware. Estes espaços são utilizados por alunos de cursos técnicos e superiores.
          </Text>
          ...
          <View style={styles.labContainer}>
            ...
            <View style={styles.table}>
              <TouchableOpacity style={styles.tableRow} activeOpacity={0.6}>
                ...
                <Text style={styles.tableText}>31 Computadores (Core 2 Duo 2,93 GHz, 3 GB RAM, 500 GB HD)</Text>
              </TouchableOpacity>
              <TouchableOpacity style={styles.tableRow} activeOpacity={0.6}>
                <View style={styles.tableIcon}>
                  <MaterialCommunityIcons name="air-conditioner" size={24} color="#FF4500" />
          ...
          <View style={styles.labContainer}>
            ...
            <View style={styles.table}>
              <TouchableOpacity style={styles.tableRow} activeOpacity={0.6}>
                ...
                <Text style={styles.tableText}>32 Computadores (AMD Phenom II X 3.2 GHz, 4 GB RAM, 500 GB HD)</Text>
              </TouchableOpacity>
              <TouchableOpacity style={styles.tableRow} activeOpacity={0.6}>
                <View style={styles.tableIcon}>
                  <MaterialCommunityIcons name="air-conditioner" size={24} color="#FF4500" />
          ...
          <View style={styles.labContainer}>
            ...
            <View style={styles.table}>
              ...
              <TouchableOpacity style={styles.tableRow} activeOpacity={0.6}>
                ...
                <Text style={styles.tableText}>26 Computadores (Core 2 Duo 2,93 GHz, 3 GB RAM, 500 GB HD)</Text>
              </TouchableOpacity>
              <TouchableOpacity style={styles.tableRow} activeOpacity={0.6}>
                <View style={styles.tableIcon}>
                  <MaterialCommunityIcons name="air-conditioner" size={24} color="#FF4500" />
